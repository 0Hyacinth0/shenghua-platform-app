...
5. **The admin panel (jeecgclient/) has its own AGENTS.md** at `jeecgclient/AGENTS.md` with detailed architecture documentation — reference it when working on the admin side.
