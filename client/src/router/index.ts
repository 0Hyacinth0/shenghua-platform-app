...
const router = createRouter({
  ...
  routes: [
    ...
    },
    {
      ...
      meta: { showTabBar: true, tabKey: 'learn' },
    },
    {
      path: '/community',
      name: 'community',
    ...
    },
    {
      ...
      meta: { showTabBar: true, tabKey: 'messages' },
    },
    {
      path: '/profile',
      name: 'profile',
    ...
    // ====== 内容详情页（有 TabBar 但非切换 tab） ======
    {
      ...
      children: [
        ...
        // 购物车（在"我的"页面里也有入口）
        { path: 'cart', name: 'cart', component: () => import('@/views/cart/index.vue'), meta: { showTabBar: true } },
        // 结算
