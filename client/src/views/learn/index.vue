...
<style scoped>
.learn-page { padding: 0 16px; max-width: 480px; margin: 0 auto; padding-bottom: 100px; }
...
.card-prog { font-size:11px; color:#2b85e4; }
.resume-btn { padding:3px 10px; background:#2b85e4; color:#fff; border:none; border-radius:10px; font-size:11px; cursor:pointer; }
.prog-bar { height:4px; border-radius:2px; margin:6px 0 4px; overflow:hidden; display:flex; }
.prog-learned { height:100%; background:#2b85e4; }
