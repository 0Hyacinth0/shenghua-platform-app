...
.price { font-size:22px; font-weight:bold; color:#f5222d; }
.pay-btn { width:100%; padding:14px; margin-top:24px; border:none; border-radius:24px; font-size:17px; font-weight:bold; color:#fff; background:linear-gradient(135deg,#f5222d,#fa541c); cursor:pointer; }
