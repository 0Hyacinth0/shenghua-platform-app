...
.ov-value { font-size:20px; font-weight:bold; color:#2b85e4; }
...
.w-btn { padding:6px 16px; background:#2b85e4; color:#fff; border:none; border-radius:14px; font-size:13px; cursor:pointer; }
...
.max-hint { font-size:11px; color:#2b85e4; display:block; margin-top:2px; }
...
.wi-s-2 { color:#f5222d; font-size:12px; }
