...
.a-2 { color: #52c41a; }
.a-3 { color: #f5222d; }
.item-actions button { padding: 6px 14px; border: 1px solid #2b85e4; background: #fff; color: #2b85e4; border-radius: 14px; font-size: 12px; cursor: pointer; }
...
.save-btn { flex: 1; padding: 10px; background: #2b85e4; color: #fff; border: none; border-radius: 12px; cursor: pointer; }
.add-btn { width: 100%; padding: 14px; background: #2b85e4; color: #fff; border: none; border-radius: 24px; font-size: 16px; cursor: pointer; position: fixed; bottom: 80px; left: 16px; right: 16px; max-width: 480px; margin: 0 auto; }
