...
.status-card button { padding:10px 24px; background:#2b85e4; color:#fff; border:none; border-radius:20px; font-size:14px; cursor:pointer; }
...
.submit-btn { width:100%; padding:14px; background:linear-gradient(135deg,#2b85e4,#1a6dd4); color:#fff; border:none; border-radius:24px; font-size:16px; font-weight:bold; cursor:pointer; }
