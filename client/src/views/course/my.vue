...
<style scoped>
.my-page { padding:16px; background:#f7f8fa; min-height:100vh; }
...
.progress-fill { height:100%; background:#2b85e4; border-radius:2px; transition:width .3s; }
.card-bottom { display:flex; justify-content:space-between; align-items:center; }
.progress-text { font-size:11px; color:#2b85e4; }
.continue-btn { padding:4px 14px; background:#2b85e4; color:#fff; border:none; border-radius:12px; font-size:12px; cursor:pointer; }
.empty { text-align:center; padding:60px 20px; }
.empty-icon { font-size:60px; }
.empty p { color:#999; margin:12px 0; }
.go-btn { padding:10px 32px; background:#2b85e4; color:#fff; border:none; border-radius:20px; font-size:15px; cursor:pointer; }
</style>
