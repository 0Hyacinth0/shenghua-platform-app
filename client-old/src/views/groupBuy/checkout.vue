...
<style scoped>
.checkout-page { min-height: 100vh; background: var(--color-bg-page, #F7F7F8); padding: 16px; padding-bottom: calc(var(--tab-bar-height, 56px) + var(--safe-bottom, 0px) + 12px); }
h2 { margin: 0 0 16px; }
...
.price { font-size: 20px; font-weight: 700; color: var(--color-primary, #FF4D4F); }
...
.pay-amount { font-size: 28px; font-weight: 700; color: var(--color-primary, #FF4D4F); }
</style>
