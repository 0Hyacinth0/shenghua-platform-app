...
<style scoped>
.chat-page {  display: flex; flex-direction: column; height: 100vh; background: var(--color-bg-page, #F7F7F8); }
...
.mine .bubble-content { background: var(--color-primary, #FF4D4F); color: #fff; border-bottom-right-radius: 4px; }
...
.chat-input-bar { display: flex; gap: 8px; padding: 12px 16px; background: #fff; border-top: 1px solid #eee; padding-bottom: calc(12px + var(--safe-bottom, 0px)); }
</style>
