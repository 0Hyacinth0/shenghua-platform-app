...
.cover-bg { width:100%; height:100%; background:linear-gradient(135deg,var(--color-primary, #FF4D4F),#E8383A); display:flex; align-items:center; justify-content:center; }
...
.price-value { flex:1; }
.num { font-size:24px; font-weight:bold; color:var(--color-primary, #FF4D4F); }
.num.free { color:#52c41a; }
.num.purchased { color:var(--color-primary, #FF4D4F); font-size:16px; }
.buy-btn { padding:10px 20px; border:none; border-radius:20px; font-size:14px; font-weight:bold; color:#fff; background:linear-gradient(135deg,var(--color-primary, #FF4D4F),#FF7875); cursor:pointer; white-space:nowrap; }
.buy-btn.started { background:linear-gradient(135deg,var(--color-primary, #FF4D4F),#E8383A); }
...
.ch-price { font-size:11px; color:var(--color-primary, #FF4D4F); }
.ch-bought { font-size:11px; color:var(--color-primary, #FF4D4F); }
.ch-buy { padding:2px 10px; border:1px solid var(--color-primary, #FF4D4F); background:#fff; color:var(--color-primary, #FF4D4F); border-radius:10px; font-size:11px; cursor:pointer; }
