...
<style scoped>
.course-page { background:var(--color-bg-page, #F7F7F8); min-height:100vh; padding-bottom:calc(var(--tab-bar-height, 56px) + var(--safe-bottom, 0px) + 12px); }
...
.cate-item.active { color:var(--color-primary, #FF4D4F); background:var(--color-primary-light, #FFF1F0); font-weight:bold; }
...
.filter-row span.active { background:var(--color-primary-light, #FFF1F0); color:var(--color-primary, #FF4D4F); font-weight:bold; }
...
.price { font-size:15px; font-weight:bold; color:var(--color-primary, #FF4D4F); }
