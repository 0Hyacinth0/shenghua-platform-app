...
<style scoped>
.dist-page { padding: 16px; min-height: 100vh; background: var(--color-bg-page, #F7F7F8); padding-bottom: calc(var(--tab-bar-height, 56px) + var(--safe-bottom, 0px) + 12px); }
...
.team-commission { font-size: 15px; font-weight: 600; color: var(--color-primary, #FF4D4F); }
...
.record-amount { font-size: 14px; font-weight: 600; color: var(--color-primary, #FF4D4F); }
</style>
