...
<script lang="ts" name="mall-coupon" setup>
  ...
  function handleDelete(record) {
    deleteCoupon({ id: record.id }, reload);
  }

  function batchHandleDelete() {
    batchDeleteCoupon({ ids: selectedRowKeys.value.join(',') }, reload);
  }
